...
def download_if_not_exists(url, local_filename):
    """
    Downloads a file from a given URL to a local path if the file does not already exist.
    """
...
def main(args):
    ...
    download_if_not_exists("https://github.com/microsoft/DNS-Challenge/raw/refs/heads/master/DNSMOS/DNSMOS/sig_bak_ovr.onnx", args.primary_model)
    download_if_not_exists("https://github.com/microsoft/DNS-Challenge/raw/refs/heads/master/DNSMOS/DNSMOS/model_v8.onnx", args.p808_model)
...
if __name__ == "__main__":
    ...
    group.add_argument(
        "--primary_model",
        type=str,
        default="./eval/DNSMOS/sig_bak_ovr.onnx",
        help="Path to the primary DNSMOS model.",
    )
    group.add_argument(
        "--p808_model",
        type=str,
        default="./eval/DNSMOS/model_v8.onnx",
